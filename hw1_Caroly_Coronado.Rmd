...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hi! My name is **Caroly Coronado**. I am a second-year student studying *statistics* and minoring in data science. I currently work for CSAFE(Center for Statistics and Applications in Forensic Evidence) as an undergraduate researcher. I have heard many great things about this course and I am excited to learn R!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: A job that I think is related to data science is a data anyalist at a company such as John Deere or Principal. I first heard about data sciece during a tour of the Princial building in Des Moines. From there, I always associate data science with principal. Similarly, I associate data sciecne jobs with those found at john deere finaicla group. 

  ![](C:/Users/Caroly/Desktop/DS 202/ds202_hw1/logo.png){#id .class width=25% height=25% fig.align='center'}
    
   [Link to Job openings in data science at Principal Finanical Group:](https://www.theladders.com/job/sr-data-analyst-principalfinancialgroup-des-moines-ia_47850253?utm_campaign=google_jobs_apply&utm_source=google_jobs_apply&utm_medium=organic)
    
  
5. What data topic will you be most interested in? (Optional) Provide a source of such data set if you have.

    Answer: I will be most intrested in the FBSI/forensic data sets becuase I know it will help me understand my own on-campus job better. Since working  with CSAFE, I have became more intrested in data sciecne behind forensics.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: git version 2.32.0.windows.1
